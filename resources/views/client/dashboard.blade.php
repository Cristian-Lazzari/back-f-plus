...
<div class="page_nav">
    ...
    <div class="client-db ">
        <div class="left">
            <h2 class="title_lg">Le tue attività</h2>
                    ...
                    <div class="split">
                        <div class="input_form">
                            ...
                            <div class="select">
                                ...
                                type="radio" class="btn-check" id="type_agency" name="type_agency" value="1" >
                                <label class="my_btn-check" for="type_agency">Libero professionista</label>
                                <input
                                @if ($c->type_agency == 2) checked @endif
                                type="radio" class="btn-check" id="type_agency1" name="type_agency" value="2" >
                                <label class="my_btn-check" for="type_agency1"> Ditta individuale</label>
                                <input
                                @if ($c->type_agency == 3) checked @endif
                                type="radio" class="btn-check" id="type_agency2" name="type_agency" value="3" >
                ...
                <form class="form-reg form-home" action="{{ route('client.complete_registration') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="menu">
                        ...
                        <div class="container_file" > 
                            <div class="header_file" id="dropzone"> 
                            ...
                            <input id="fileInput" type="file" multiple name="menu[]"> 
                          </div>
                    </div>
